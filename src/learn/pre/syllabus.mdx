...
All students are expected to submit work on-time. An assignment is considered **late** when it is submitted one day after it is due. An assignment is considered **missing** when it is not submitted or submitted more than two days after it is due.

**Late work will receive three quarter credit (75%) the first day, half credit (50%) the second day, and missing work will receive zero (0%) credit.**
