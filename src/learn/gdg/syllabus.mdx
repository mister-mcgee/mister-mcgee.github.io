---
title: Game Design in Godot Syllabus
tags: [ "gdg", "syllabus" ]
---

## Course Description

> In this hands-on, project-based course, students will dive into the world of game design using Godot, a powerful and open-source game engine. Throughout the semester, students will learn the fundamentals of game programming, game engine design, and the tools needed to build and publish games. Students will also gain proficiency in version control systems like Git. The course will emphasize the use of open-source software, empowering students to understand how they can modify, extend, and contribute to game engines and tools. By the end of the course, students will have a portfolio piece - an original 2D game published to the web - demonstrating their understanding of the game development process from concept to deployment.
...
3. Jacket or Hoodie for use on cooler days (three exterior walls make the shop chilly on cold days).
