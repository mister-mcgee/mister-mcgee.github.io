...
Your retrospective *must* be *at least* five paragraphs in length. There is no sentence requirement; however, keep in mind a paragraph should convey a clear concept. An essay less than five paragraphs will be awarded *at most* 1 point(s) per paragraph.  
...
- (6 Points) At least 3 paragraphs [explaining the process](#explain-the-process) and/or [proposing alternatives](#propose-alternatives).
...
> [!info] Pro Tip - Each Required Concept Can be a Paragraph!

#### Rubric

import Rubric from "@components/learn/assessments/Rubric.astro";
import essay  from "@learn/about/essay.json";
...
Your presentation must be between two and four minutes. If you are using a slideshow in your presentation, aim for *at least* three slides.

#### Content (8 Points)

Your presentation should include the following -

- (2 Points) A brief overview of the project 
- (4 Points) At least one major point from your essay 
- (2 Points) A summary of your presentation 
...
import slides from "@learn/about/slides.json";

<Rubric rubric={slides}/>