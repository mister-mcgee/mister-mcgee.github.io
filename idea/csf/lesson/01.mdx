...
After constructing the Difference Engine, Babbage moved on to design a relatively powerful machine capable of more complex calculations that he called the Analytical Engine. Although it was never actually built, the Analytical Engine is often cited as the first programmable mechanical computer. A mathematician by the name of Ada Lovelace is often credited with being the first person to write a program for the Analytical Engine over correspondence with Babbage.
