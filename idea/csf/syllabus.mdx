# Robotics I - Computer Science Foundations
...
### Contact
Email: <a href="mailto:shawn.mcgee@jamesirwin.org">shawn.mcgee@jamesirwin.org</a><br/>
Phone: <a href="tel:+17193016200,1100">719-301-6200, ext 1100</a><br/>
...
- Turning in their own work. %%(Plagiarism, AI)%%
...
- Being a good steward of the classroom and the equipment therein.
- Engaging without being disruptive.
- Using positive language when addressing themself or others.
...
A student can demonstrate **Excellence** in my class by -
- Having the courage to be curious.
...
2. Put classroom equipment where it belongs.
3. Silently wait to be dismissed by the instructor.

---
# Attendance
### Tardy
A student will be marked **tardy** when they -
1. Are not in the classroom when the bell rings.
2. Are not in their assigned seat within one minute of the bell.
3. Are not silently and independently working on the bell work within one minute of the bell.

### Absences
A student will be marked **absent** when they -
1. Arrive to class more than 15 minutes after the bell **without a pass**.
...
1. A binder with paper or a spiral notebook for taking notes, holding homework, and keeping handouts.
2. A pen or pencil for taking notes.

### Optional Items
A student **MAY** bring the following item(s) to class -
1. Backpack (must remain in the designated drop zone).
2. Translucent water bottle with a functioning lid.
3. Personal laptop or chromebook (CAD and Robotics only).
...
1. To remain professional and accountable, digital communication between stucdents and instructors should always take place via approved channels, such as school-provided email, google classroom, and infinite campus.
...
### Reserving Electronics
Students may reserve electronics from the lab to complete in-class work and assignments. All reserved equipment must be returned by the end of class, unless otherwise specified by the instructor.

### Personal Electronics
Students must receive approval from the instructor prior to bringing personal electronics to class. Approved personal electronics may be used to complete in-class work and assignments.
...
### Electronics Priveleges
The use of technology in the classroom is a privelege. A student found to be abusing or misuing electronics will have their access revoked and receive a referral to the dean. Infractions include, but are not limited to -
1. Using electronics outside of approved contexts.
2. Failure to return reserved equipment.
3. Harassment or bullying.
4. Damage of school equipment due to vandalism or negligence.
5. Viewing or sharing of gore, violence, and sexually explicit material.
